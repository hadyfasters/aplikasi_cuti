<form action="<?php echo base_url('validasi/save'); ?>" method="POST" enctype="multipart/form-data">
	...
	<div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
		<div class="form-group text-center">
			<input type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to Reject this?')" value="Reject">
