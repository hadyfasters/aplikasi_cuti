	...
	<div class="col-sm-6 col-md-6 col-lg-6 col-xs-12">
			...
			<select name="cuti" id="cuti" class="form-control input-sm" required>
				...
				<?php 
					foreach ($jenis_cuti as $jc) {
						...
						if($jc->kode_cuti === $cuti)
						{
							echo '<option value="'.$jc->kode_cuti.'" selected>'.$jc->nm_cuti.' ('.$sisa.')</option>';
						}else{
		...
		<div class="form-group">
			...
			<div class="input-group">
				<input type="text" name="tgl_awal" id="tgl_awal" class="form-control input-sm" placeholder="Tanggal Awal - mm/dd/yyyy" value="<?php echo $tgl_awal; ?>" required>
		...
		<div class="form-group">
			...
			<div class="input-group">
				<input type="text" name="tgl_akhir" id="tgl_akhir" class="form-control input-sm" placeholder="Tanggal Akhir - mm/dd/yyyy" value="<?php echo $tgl_akhir; ?>" required>
				<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
			</div>
		</div>
		<div class="form-group">
			<label for="jumlah">Jumlah Cuti<span class="required"> *</span></label>
			<input type="number" name="jumlah" id="jumlah" class="form-control input-sm" min="1" placeholder="Jumlah Cuti" value="<?php echo $jumlah; ?>" required>
		</div>
		<div class="form-group">
			<label for="keterangan">Keterangan<span class="required"> *</span></label>
			<textarea name="keterangan" id="keterangan" class="form-control input-sm" placeholder="Keterangan" required><?php echo $keterangan; ?></textarea>
		</div>
	</div>
